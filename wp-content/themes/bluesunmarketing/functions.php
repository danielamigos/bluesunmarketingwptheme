...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        wp_register_script('bootstrap', get_template_directory_uri() . '/js/lib/bootstrap.min.js', array('jquery'), '3.3.4'); // Custom scripts
        wp_enqueue_script('bootstrap'); // Enqueue it!
        
        wp_register_script('jquery.easing', get_template_directory_uri() . '/js/lib/jquery.easing.min.js', array('jquery'), '1.3.0'); // Custom scripts
        wp_enqueue_script('jquery.easing'); // Enqueue it!
        
        wp_register_script('scrolling-nav', get_template_directory_uri() . '/js/lib/scrolling-nav.js', array('jquery'), '1.0.0'); // Custom scripts
...
function html5blank_conditional_scripts()
{
    ...
    if (is_page_template('template-scrollingpage.php')) {
...
{    
    ...
    wp_register_style('scrolling-nav', get_template_directory_uri() . '/css/scrolling-nav.css', array(), '1.0.0', 'all');
    wp_enqueue_style('scrolling-nav'); // Enqueue it!
